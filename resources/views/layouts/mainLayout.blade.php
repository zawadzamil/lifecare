        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarmain">
                <ul class="navbar-nav ml-auto">
                    ...
                    @if(Auth::user())
                        <li class="nav-item"><a class="nav-link" href="{{url('profile')}}"><i class="fa fa-user">{{Auth::user()->name}}</i> </a></li>
                        <li class="nav-item">
...
<!-- footer Start -->
<footer class="footer section " style="background-color: #090232; color: #c4d5a5;" >
    <div class="container">
        <div class="row">
