...
@section('body_parts')
    @php
        ...
        $selDoc = \App\Models\Doctor::where('id',$id)->get();
        $depid = \App\Models\Doctor::where('id',$id)->value('department_id');
        $selDept = \App\Models\Departments::where('id',$depid)->get();
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <select class="form-control" id="exampleFormControlSelect2" name="doctor_id" required>
                                            <option selected="true" >{{$selDoc[0]->name}}</option>
                                            @foreach($docs as $doc)
